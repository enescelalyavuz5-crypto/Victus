...
tools_schema = [
    ...
    {"type": "function", "function": {"name": "find_and_focus_tab", "description": "Sekme bulur.", "parameters": {"type": "object", "properties": {"tab_name": {"type": "string"}}, "required": ["tab_name"]}}},
    ...
    {"type": "function", "function": {"name": "file_manager", "description": "Dosya işlemi.", "parameters": {"type": "object", "properties": {"action": {"type": "string", "enum": ["copy", "move", "delete"]}, "path": {"type": "string"}, "destination": {"type": "string"}}, "required": ["action", "path"]}}},
    ...
    {"type": "function", "function": {"name": "type_text", "description": "Klavye gönder.", "parameters": {"type": "object", "properties": {"text": {"type": "string"}}, "required": ["text"]}}},
...
async def think_and_act(user_input):
    ...
    # GÜVENLİ HAFIZA BUDAMA (400 HATASI ÇÖZÜMÜ)
    if len(memory) > 20:
        new_memory = [memory[0]]
